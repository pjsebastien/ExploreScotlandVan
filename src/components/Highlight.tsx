...
interface HighlightItem {
  title: string;
  description: string;
  icon?: 'mountain' | 'road' | 'bed' | 'camera' | 'map' | 'euro';
}
...
export default function Highlight({ title, subtitle, items }: HighlightProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {items.map((item, index) => (
            ...
            >
              {item.icon && (
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-lg bg-forest-100 text-forest-700 mb-4">
                  {icons[item.icon]}
                </div>
              )}
